...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(48), __webpack_require__(302)(module)))
...
var _element = __webpack_require__(116);
...
var CSS = function () {
  ...
  _createClass(CSS, [{
    key: 'getClassHash',
    value: function getClassHash() {
      return 'nicobar-' + Math.random().toString(36).substring(7);
    }
  }, {
    key: 'hasNicobar',
    value: function hasNicobar(element) {
      var classNames = element.className.split(' ');

      return _lodash2.default.filter(classNames, function (className) {
        return className.indexOf('nicobar-') !== -1;
      })[0];
    }
  }, {
    key: 'intelligentSelector',
    value: function intelligentSelector(element) {
      var selector = this.hasNicobar(element);

      if (element.id) {
        return '#' + element.id;
      } else if (!selector) {
        selector = this.getClassHash();
        _element2.default.setElementClass.call(this, element, selector);
      }
      return '.' + selector;
    }
  }, {
    key: 'fromObjToCss',
    value: function fromObjToCss(object) {
      return Object.keys(object).reduce(function (css, variable) {
...
var Nicobar = function () {
  function Nicobar() {
    _classCallCheck(this, Nicobar);
  ...
  _createClass(Nicobar, [{
    key: 'render',
    value: function render() {
      var _this = this;

      var styleString = Object.keys(this.selectors).reduce(function (styleStr, selector) {
        return styleStr += selector + ' { ' + _css2.default.fromObjToCss(_this.selectors[selector]) + ' }';
      }, '');
    ...
    key: 'set',
    value: function set(target, data) {
      var selector = void 0;

      if (_lodash2.default.isElement(target)) {
        selector = _css2.default.intelligentSelector(target);
        target = [target];
      } else {
        selector = target;
...
/***/ })
/******/ ]);
//# sourceMappingURL=nicobar.js.map